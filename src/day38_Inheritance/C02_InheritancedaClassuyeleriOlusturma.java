...
public class C02_InheritancedaClassuyeleriOlusturma extends C01_Parent {
    String s = "Ali";
    String t = "Veli";
    int a = 33;
    int b = 34;
    ...
    public static void main(String[] args) {
        ...
        C02_InheritancedaClassuyeleriOlusturma obj=new C02_InheritancedaClassuyeleriOlusturma();
        obj.method1();
