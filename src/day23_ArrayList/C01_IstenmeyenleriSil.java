...
public class C01_IstenmeyenleriSil {
    public static void main(String[] args) {
       ...
       // kalan kismini list olarak bize donduren bir method olusturun
        List<String>isimler=new ArrayList<>(Arrays.asList("Seher","Seren","Meltem","Sait","Hasan"));
        String istenmeyenHarf="e";
        System.out.println(isimler);//"Seher","Seren","Meltem","Sait","Hasan"
        System.out.println(istenmeyenHarflerisil(isimler,istenmeyenHarf));//Sait,Hasan
