...
public class C03_ClassLevelvariable {
    ...
    public static void main(String[] args) {
        ...
        1- class level variable'larin scope'u BUTUN CLASS'dir
           ancak class level variable'larin metod icerisinde direk kullanilip
            kullanilamamasi static keyword'u de bagladir

        2- Variable static olarak isaretlenmisse
           class icerisinde her yerde direk kullanilabilir
           ama variable static(instance) degilse, static method'lardan kullanilamaz
